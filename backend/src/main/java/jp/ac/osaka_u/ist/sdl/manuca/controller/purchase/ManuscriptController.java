...
public class ManuscriptController {
  ...
  private static final int PHRASE_MAX_LENGTH = 3;
  ...
  private static ManuscriptResponseBody convert(ManuscriptEntity origin) {
    return new ManuscriptResponseBody(
        origin.getId(), KuromojiAnalysis.phrase(origin.getManuscript(), PHRASE_MAX_LENGTH));
  }
}
